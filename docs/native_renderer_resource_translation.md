...
1. Add sidecar resource payloads for draw-time color/depth targets so JSONL stays bounded. PM4 swap/frontbuffer sidecars are implemented but black for the tested early frames.
