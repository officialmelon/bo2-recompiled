...
3. Add sidecar/full-payload texture snapshots, expand texture format/mip decoding, and capture render-target/depth resources for the same tested frame.
