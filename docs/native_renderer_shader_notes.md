...
- `xenos_limited_semantic_v4` now uses that typed real-resource PS evidence to generate cacheable HLSL for PS `0xC4ED2979F29C9139`. This is not a complete instruction-by-instruction PS translator yet: it recognizes the four-`tfetch2D`/export pattern and maps `tf4/tf3/tf2/tf1` to the four per-draw D3D12 replay descriptors `t0/t1/t2/t3`.
