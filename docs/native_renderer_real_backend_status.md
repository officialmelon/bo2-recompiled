...
- Strict result after vertexless B6/A4 and no-side-effect elision: exit `1`, `D3D12 frame replay strict failure at frame 0 draw 1967 event 1968 VS=0xDDED7E538422AE73 PS=0x3A6876055FEC1674: draw has no captured vertex/fetch state`.
