...
1. Add sidecar/full-payload texture snapshots and expand conversion beyond 2D format `6`: mip footprints, compressed/packed formats, and additional captured formats.
