...
| `default` `sub_82582A30` at `loc_82582C84`; `default_mp` `sub_82117D20` at `loc_82117F74` | Generated code writes `lis -16384` then `ori 0x3600`, followed by initiator payload stores. | Medium | Dispatcher-level runtime logger installed. Direct generated calls still need a trampoline or lower-level interception before this is guaranteed to fire. |
