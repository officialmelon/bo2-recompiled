...
- Shader/material record probe callbacks now fire for `0x82597F50` on Windows generated-function detours. `shader_probe_capture_003` proved that the hook must treat `0xA0000000` / `0xB0000000` physical aliases as valid guest pointers: `r3=0xBF8F5F80`, `r4=0xA5BE7AE0` / `0xA5BE7374`, `r5=0xA6019BC0` / `0xA6019940`, and the primary/secondary snapshots decode successfully after including those ranges.
- `0x82597F50` probe snapshots show shader-record names in the primary record and shader-like words in the secondary pointer. Verified names: `pimp_shader_cinematic_519f564_ps_main_ps_3_0_534c8cc25dea1826410cc2974d7e9a80.updb` and `pimp_shader_radiant_190f4788_vs_main_vs_3_0_e10bcefc8da60302d0bbf12b675d091c.updb`.
