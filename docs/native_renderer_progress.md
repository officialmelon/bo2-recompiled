...
- The currently verified translated subset covers runtime VS `0xB6C9863F710683EC`, PS `0xA4A965C189287B99`, the real-resource VS `0x5D918D91043B3ED0`, and a limited generated lowering for real-resource PS `0xC4ED2979F29C9139`. The PS lowering recognizes the captured four-`tfetch2D` plus `mul oC0` pattern, but still collapses the shader's fetch constants onto the D3D12 replay backend's current single bound texture/sampler.
