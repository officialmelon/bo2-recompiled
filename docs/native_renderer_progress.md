...
5. Find the ReXGlue/Xenos render-target backing/readback path. CPU-memory frontbuffer and target-base sidecars are implemented but zero for the tested captures.
