...
5. Add draw-time color/depth render-target payload sidecars. PM4 swap/frontbuffer sidecars now work, but the captured present payload is currently black/zero for the tested early frames.
