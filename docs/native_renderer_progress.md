...
- The currently verified translated subset covers only runtime VS `0xB6C9863F710683EC` and PS `0xA4A965C189287B99` from `shader_probe_capture_007`. The real-resource shader pair used by D3D12 replay, `VS=0x5D918D91043B3ED0` / `PS=0xC4ED2979F29C9139`, still depends on manual overrides until more Xenos op lowering is implemented.
