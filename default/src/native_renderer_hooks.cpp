...
void InstallDefaultNativeRenderer(rex::Runtime* runtime) {
  ...
  InstallGeneratedDispatcherHook(dispatcher, kDrawPacketCandidate, &sub_82582A30,
                                 &default_native_draw_packet_candidate,
                                 &original_draw_packet_candidate, "sub_82582A30");
  ...
  InstallGeneratedDispatcherHook(dispatcher, kShaderUploadImmediate, &sub_8258CCE8,
  ...
  InstallGeneratedDispatcherHook(dispatcher, kMaterialShaderLoad, &sub_82598140,
                                 ...
                                 &original_material_shader_load, "sub_82598140");
  ...
  InstallGeneratedDispatcherHook(dispatcher, kCommandBufferReserve, &sub_8257AD38,
                                 &default_native_command_buffer_reserve,
                                 &original_command_buffer_reserve,
                                 "sub_8257AD38");
